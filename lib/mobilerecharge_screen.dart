...
class mobilerecharge_screen extends StatefulWidget {
  const mobilerecharge_screen({Key? key}) : super(key: key);

  @override
  State<mobilerecharge_screen> createState() => _mobilerecharge_screenState();
}

class _mobilerecharge_screenState extends State<mobilerecharge_screen> {
  late String pin;
  int balance1=0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("MOBILE RECHARGE")),
      ),
      body: Container(
